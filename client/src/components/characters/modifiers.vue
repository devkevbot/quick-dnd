  ...
  computed: {
    statSlider() {
      return [
        ...
        { attribute: 'Constitution', value: this.characterData.constitution, max: 30 },
        { attribute: 'Wisdom', value: this.characterData.wisdom, max: 30 },
        { attribute: 'Hit Points', value: this.characterData.hp_max, max: 440 },
        { attribute: 'Dexterity', value: this.characterData.dexterity, max: 30 },
        { attribute: 'Ability Points', value: this.characterData.ability_points, max: 180 },
        { attribute: 'Charisma', value: this.characterData.charisma, max: 30 },
        { attribute: 'Intellect', value: this.characterData.intelligence, max: 30 },
      ];
    },
    statModifiers() {
      return [
        ...
        { modifier: 'Hit Points', value: 'TEMP', max: 440 },
